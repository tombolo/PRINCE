...
export const domain_app_ids = {
    'smarttraderstool.com': 107793,
    'deriv.app': 107793,
    'app.deriv.com': 107793,
    'staging-app.deriv.com': 107793,
    'app.deriv.me': 107793,
    'staging-app.deriv.me': 107793,
    'app.deriv.be': 107793,
    'staging-app.deriv.be': 107793,
    'binary.com': 107793,
    'test-app.deriv.com': 107793,
    'royal-app-seven.vercel.app': 107793,
    'star-eight-ruby.vercel.app': 107793,
    'beleiver.vercel.app': 107793,
    'goon-puce.vercel.app': 107793,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 107793 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 107793;
